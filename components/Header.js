...
function Header() {
  return (
    <header className='flex justify-between items-center flex-col sm:flex-row'>
        <div className='flex flex-grow justify-evenly max-w-2xl sm:px-10 mt-3'>
            <LinkIcon Icon={ <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
